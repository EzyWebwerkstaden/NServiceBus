namespace NServiceBus.Core.Tests
{
    ...
    public class ForwardFaultsToErrorQueueTests
    {
        ...
        {
            return new TransportReceiveContext(new IncomingMessage(messageId, new Dictionary<string, string>(), new MemoryStream()), "InputQueue", null, new CancellationTokenSource(), new RootContext(null, new FakePipelineCache(pipeline)));
        }
